...
const navHtml = `
    ...
    <aside class="sidebar fixed left-0 top-0 h-full text-gray-300 flex flex-col shadow-2xl z-50 transition-all duration-300">
        ...
        <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
            ...
            <a href="active-students.html" class="sidebar-link flex items-center px-3 py-3 rounded-lg text-sm ${window.location.pathname.endsWith('active-students.html') ? 'active' : ''}">
