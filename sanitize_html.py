...
footer_template = """    <footer class="bg-gray-900 text-white pt-16 pb-8 border-t border-gray-800">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                ...
                <div class="space-y-6">
                    <div class="flex items-center">
                        ...
                        <span class="font-bold text-xl tracking-wide">Quva Politexnikumi</span>
                    </div>
                    <p class="text-gray-400 text-sm leading-relaxed max-w-xs" data-i18n="footer-desc">
                        Kelajak kasblarini biz bilan egallang. Zamonaviy ta'lim, innovatsion texnologiyalar va amaliy
                        ko'nikmalar maskani.
                    </p>
                ...
                <div class="md:pl-10">
                    <h4 class="text-white font-bold text-lg mb-6 relative inline-block">
                        <span data-i18n="footer-pages">Sahifalar</span>
                        <span class="absolute bottom-0 left-0 w-1/2 h-1 bg-blue-500 rounded-full"></span>
                    </h4>
                    <ul class="space-y-4">
                        <li><a href="/" class="text-gray-400 hover:text-white hover:translate-x-2 transition-transform duration-300 inline-block flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span><span data-i18n="nav-home">Bosh sahifa</span></a></li>
                        <li><a href="sohalar.html" class="text-gray-400 hover:text-white hover:translate-x-2 transition-transform duration-300 inline-block flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span><span data-i18n="nav-fields">Yo'nalishlar</span></a></li>
                        <li><a href="about.html" class="text-gray-400 hover:text-white hover:translate-x-2 transition-transform duration-300 inline-block flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span><span data-i18n="nav-about">Biz haqimizda</span></a></li>
                        <li><a href="students.html" class="text-gray-400 hover:text-white hover:translate-x-2 transition-transform duration-300 inline-block flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span><span data-i18n="nav-students">O'quvchilar uchun</span></a></li>
                        <li><a href="news.html" class="text-gray-400 hover:text-white hover:translate-x-2 transition-transform duration-300 inline-block flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span><span data-i18n="nav-news">Yangiliklar</span></a></li>
                        <li><a href="contact.html" class="text-gray-400 hover:text-white hover:translate-x-2 transition-transform duration-300 inline-block flex items-center"><span class="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span><span data-i18n="nav-contact">Aloqa</span></a></li>
                    </ul>
                </div>
                ...
                <div>
                    <h4 class="text-white font-bold text-lg mb-6 relative inline-block">
                        <span data-i18n="footer-contact">Bog'lanish</span>
                        <span class="absolute bottom-0 left-0 w-1/2 h-1 bg-blue-500 rounded-full"></span>
                    </h4>
                    <ul class="space-y-4">
                        <li class="flex items-start group">
                            ...
                            <span class="text-gray-400 text-sm leading-relaxed pt-2" data-i18n="footer-address">Farg'ona viloyati, Quva tumani,<br>A.Navoiy ko'chasi 1-uy</span>
                        </li>
            ...
            <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-500 text-sm" data-i18n="footer-rights">&copy; 2024 Quva tumani Politexnikumi. Barcha huquqlar himoyalangan.</p>
                <div class="flex space-x-6 mt-4 md:mt-0">
                    <a href="#" class="text-gray-500 hover:text-white text-sm transition-colors" data-i18n="footer-privacy">Maxfiylik siyosati</a>
                    <a href="#" class="text-gray-500 hover:text-white text-sm transition-colors" data-i18n="footer-terms">Foydalanish shartlari</a>
                </div>
            </div>
        </div>
    </footer>
    <button id="backToTop" class="hidden fixed bottom-8 right-8 bg-blue-600 text-white p-3 rounded-full shadow-lg hover:bg-blue-700 transition-all z-50">
